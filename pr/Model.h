...
public:
	...
	/// <summary> 
	/// Метод для загрузки шейдеров. С целью примера загружает только 
	/// вершинный и фрагментный шейдеры 
	/// В результате выполнения будет скомпонована шейдерная 
	/// программа. 
	/// </summary> 
	...
	GLuint get_shader_programme() { return shader_programme; }
private:
	/// <summary> 
	/// ID массива вершин 
	/// </summary> 
	GLuint vao = -1;
		...
		/// Количество вершин 
		/// </summary> 
		//Начальное значение - максимальное число, заведомо невозможное
